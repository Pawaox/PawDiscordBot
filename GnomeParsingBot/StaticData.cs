...
namespace GnomeParsingBot
{
    internal abstract class StaticData
    {
        ...
        public const string PATH_FILEDATASTORE_CREDENTIALS = "gnomeParseGoogleCreds";
        ...
        public static void Initialize(string guildName, string server, WarcraftLogsClient.Region region)
        {
            ...
            AddCharacter(248853951217139713, "Dervz", "Drdervz");
            AddCharacter(312127598719139840, "Cleanst");
            AddCharacter(120938656788643841, "Lazyturtlez", "Lazytree");
            AddCharacter(625706404711235594, "Theseis", "Hieria");
            AddCharacter(248853951217139713, "Keplerr");
            AddCharacter(236483993539837952, "Degree", "Celvin");
            AddCharacter(273806201093881866, "Klazu");
            ...
            AddCharacter(377262598388711425, "Gamblerp");
            ...
            CharactersToRoles.Add("Talonpriest", new Tuple<string, string>("Tank", "Physical"));
            CharactersToRoles.Add("Bigbrainx", new Tuple<string, string>("Tank", "Physical"));
